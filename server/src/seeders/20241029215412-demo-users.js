  ...
  up: async (queryInterface, Sequelize) => {
    ...
    return queryInterface.bulkInsert('users', [
...

      {
        ...
        middle_initial: 'F',
        last_name: 'Taylor',
        street: '404 Instructor Blvd',
        city: 'Austin',
        state: 'TX',
        zip_code: '78714',
        phone: '5125550430',
        email: 'linda.instructor@example.com',
        password_hash,
        gender: 'female',
        dob: '1975-04-01',
        height: "5'9\"",
        handedness: 'right',
        referral_source: 'network',
        referral_name: 'PGA Circle',
        golf_experience: 'aLot',
        previous_lessons: 'yes',
        lesson_duration: '25+ years',
        previous_instructor: 'PGA Master Professional',
        emergency_contact_name: 'David Taylor',
        emergency_contact_phone: '5125550431',
        physician_name: 'Dr. Cooper',
        physician_phone: '5125550432',
        medical_information: 'None',
        user_type: 'instructor',
        profile_created_at: now,
        createdAt: now,
      ...
      },
      {
        ...
        middle_initial: 'J',
        last_name: 'Parker',
        street: '505 Teaching Ave',
        city: 'Austin',
        state: 'TX',
        zip_code: '78715',
        phone: '5125550433',
        email: 'chris.instructor@example.com',
        password_hash,
        gender: 'male',
        dob: '1980-11-22',
        height: "6'2\"",
        handedness: 'right',
        referral_source: 'event',
        referral_name: 'Golf World Conference',
        golf_experience: 'aLot',
        previous_lessons: 'yes',
        lesson_duration: '20+ years',
        previous_instructor: 'Golf Academy Pro',
        emergency_contact_name: 'Laura Parker',
        emergency_contact_phone: '5125550434',
        physician_name: 'Dr. Howard',
        physician_phone: '5125550435',
        medical_information: 'None',
        user_type: 'instructor',
        profile_created_at: now,
        createdAt: now,
      ...
      },
      {
        ...
        handedness: 'left',
        referral_source: 'social media',
        referral_name: 'LinkedIn',
        golf_experience: 'aLot',
        previous_lessons: 'yes',
        lesson_duration: '12+ years',
        previous_instructor: 'Tour Professional',
        emergency_contact_name: 'Jordan Brooks',
        emergency_contact_phone: '5125550437',
        physician_name: 'Dr. Green',
        physician_phone: '5125550438',
        medical_information: 'None',
        user_type: 'instructor',
        profile_created_at: now,
        createdAt: now,
      ...
      },
      {
        ...
        middle_initial: 'R',
        last_name: 'White',
        street: '707 Golf Drive',
        city: 'Austin',
        state: 'TX',
        zip_code: '78717',
        phone: '5125550439',
        email: 'jordan.instructor@example.com',
        password_hash,
        gender: 'female',
        dob: '1990-12-25',
        height: "5'10\"",
        ...
        previous_lessons: 'yes',
        lesson_duration: '10+ years',
        previous_instructor: 'Golf Magazine Top 50 Coach',
        emergency_contact_name: 'Ryan White',
        emergency_contact_phone: '5125550440',
        physician_name: 'Dr. Blue',
        physician_phone: '5125550441',
        medical_information: 'Minor knee surgery',
        user_type: 'instructor',
        profile_created_at: now,
        createdAt: now,
        updatedAt: now,
      ...
      // random golfers, fake data is hard man
      ...Array.from({ length: 20 }, (_, i) => ({
        user_id: `550e8400-e29b-41d4-a716-4466554400${17 + i}`,
        first_name: `Student${i + 1}`,
        middle_initial: 'X',
        last_name: `Lastname${i + 1}`,
        street: `${100 + i} Golf Lane`,
        city: 'Austin',
        state: 'TX',
        zip_code: `787${i % 10}`,
        phone: `5125550${440 + i}`,
        ...
        emergency_contact_phone: `5125550${450 + i}`,
        physician_name: `Dr. Physician ${i + 1}`,
        physician_phone: `5125550${460 + i}`,
        medical_information: 'None',
        user_type: 'golfer',
        profile_created_at: now,
        createdAt: now,
